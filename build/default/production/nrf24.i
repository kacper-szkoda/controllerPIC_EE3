...
# 174 "./mcc_generated_files/system/../timer/tmr0.h"
...
NRF24_INIT_STATUS nrf24_Initialize() {
    ...
    nrf24_WriteRegister(0x00, 0x02);
    _delay((unsigned long)((1500)*(64000000U/4000000.0)));


    nrf24_WriteRegister(0x02, 0x01);
    nrf24_WriteRegister(0x04, 0x00);
    nrf24_WriteRegister(0x05, 0x77);
    nrf24_WriteRegister(0x07, 0x70);


    nrf24_WriteBuffer(0x10, TXPIPE0, 5);
...
unsigned char nrf24_DataAvailable(){
    unsigned char status = (nrf24_ReadRegister(0x07) & 0x40);
    if(status == 0x40){
        return 0;
    }
    return 1;
...
void nrf24_ReadData(unsigned char *buffer){
    nrf24_ReadBuffer(0x61, buffer, 32);
    nrf24_WriteRegister(0x07, 0x70);

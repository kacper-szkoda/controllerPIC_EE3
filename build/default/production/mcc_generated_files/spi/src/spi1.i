...
# 130 "mcc_generated_files/spi/src/../spi1.h"
typedef enum
{
    HOST_CONFIG,
    SPI1_DEFAULT
...
# 160 "mcc_generated_files/spi/src/../spi1.h"
...
# 177 "mcc_generated_files/spi/src/../spi1.h"
void SPI1_BufferExchange(void * bufferData, size_t bufferSize);
# 186 "mcc_generated_files/spi/src/../spi1.h"
void SPI1_BufferWrite(void * bufferData, size_t bufferSize);
# 195 "mcc_generated_files/spi/src/../spi1.h"
...
# 228 "mcc_generated_files/spi/src/../spi1.h"
_Bool SPI1_IsRxReady(void);
# 237 "mcc_generated_files/spi/src/../spi1.h"
...
# 44 "mcc_generated_files/spi/src/../spi_interrupt_types.h"
typedef enum
{
    SPI_RESET = 0x00U,
    SPI_IDLE = 0x81U,
...
void SPI1_Initialize(void)
{
 ...
 SPI1_TxCompleteCallbackRegister(((void*)0));
...
void SPI1_BufferWrite(void *bufferData, size_t bufferSize)
{
 ...
 if (SPI_IDLE == spi1_descriptor.status)
  ...
  spi1_descriptor.transmitBuffer = bufferInput;
  spi1_descriptor.receiveBuffer = ((void*)0);
        spi1_descriptor.bytesToTransmit = bufferSize;
...
void SPI1_BufferRead(void *bufferData, size_t bufferSize)
{
 ...
 if (SPI_IDLE == spi1_descriptor.status)
  ...
  spi1_descriptor.transmitBuffer = ((void*)0);
  spi1_descriptor.receiveBuffer = bufferInput;
...
void SPI1_Transmit_ISR(void)
{
 ...
 if((size_t)0 == spi1_descriptor.bytesToTransmit)
 {
  ...
  if (SPI1_TxCompleteCallback != ((void*)0))
     {
...
void SPI1_ISR(void)
{
    ...
    if (PIR3bits.SPI1RXIF) {
            PIR3bits.SPI1RXIF = 0;
            if (spi1_descriptor.bytesToReceive > 0) {
                *spi1_descriptor.receiveBuffer = SPI1RXB;
                spi1_descriptor.receiveBuffer++;
                spi1_descriptor.bytesToReceive--;
            }
        }

        if (PIR3bits.SPI1TXIF) {
            PIR3bits.SPI1TXIF = 0;
            if (spi1_descriptor.bytesToTransmit > 0) {
                SPI1TXB = *spi1_descriptor.transmitBuffer;
                spi1_descriptor.transmitBuffer++;
                spi1_descriptor.bytesToTransmit--;
            }
        }

        if ((spi1_descriptor.bytesToTransmit == 0) && (spi1_descriptor.bytesToReceive == 0)) {
            spi1_descriptor.status = SPI_IDLE;
        }
}
